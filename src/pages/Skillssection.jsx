...
const Skillssection = () => {
    const logos = [
          {name : 'HTML', src:'./public/logos/html.png'},
          {name : 'CSS', src:'./public/logos/css-3.png'},
          {name : 'Bootstrap', src:'./public/logos/bootstrap.png'},
          {name : 'Javascript', src:'./public/logos/js.png'},
          {name : 'Typescript', src:'./public/logos/typescript.png'},
          {name : 'React', src:'./public/logos/react.png'},
          {name : 'Vue', src:'./public/logos/Vue.png'},
          {name : 'Nodejs', src:'./public/logos/nodejs.png'},
          {name : 'Nextjs', src:'./public/logos/next.jpg'},
          {name : 'Database', src:'./public/logos/database.png'},
          {name : 'Java', src:'./public/logos/java.png'},
          {name : 'Php', src:'./public/logos/php.png'},
          {name : 'Python', src:'./public/logos/python.png'},
          {name : 'Aws', src:'./public/logos/aws.png'},
          {name : 'Git', src:'./public/logos/github.png'},
          {name : 'Vs code', src:'./public/logos/vs code.png'},
{name : 'Vs code', src:'./public/logos/vs code.png'},
        ];
